...
public class YamlReader {
	...
	public static String setYamlFilePath() {
		...
		if (tier.equalsIgnoreCase("stg")) {
			...
			if(getProperty("AppToBeTested").equalsIgnoreCase("flipkart"))
			{
				yamlFilePath = "src/test/resources/testdata/PROD_TestData_Flipkart.yml";

			}
			if(getProperty("AppToBeTested").equalsIgnoreCase("snapdeal")){
