...
//		StringBuffer sb = new StringBuffer();
	...
	isElementDisplayed("Unique_Link_on_HomePage");	
    isElementDisplayed("textbox_Search");
	isElementDisplayed("search_btn");
	}

	public void Is_Suggestion_Box_Displaying(String value) {
		element("textbox_Search").sendKeys(value); 
	...
	public void Is_Suggestion_Box_Showing_Correct_Suggestions(String value) {
		wait.hardWait(3);
		isElementDisplayed("Suggestion_Term",value.toLowerCase());
		element("textbox_Search").clear();
	}
